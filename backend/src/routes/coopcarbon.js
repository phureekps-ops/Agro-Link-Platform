...
// GET /coop-carbon/projects/:projectId/evidence
...
// POST /coop-carbon/projects/:projectId/evidence
...
// POST /coop-carbon/projects/:projectId/evidence/:evidenceId/remove
...
// GET /coop-carbon/projects/:projectId/export — read-only manifest (project
// + members + evidence list) for staff to assemble a document package by
// hand; no อบก./TGO integration exists yet (see this module's own header).
