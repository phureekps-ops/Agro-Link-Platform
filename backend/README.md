...
card**: exactly ten possible line items (`plow_rough`, `spraying`,
`drying`, `straw_pelletizing`, `straw_baling`, `laser_land_leveling`, ...), one row per
