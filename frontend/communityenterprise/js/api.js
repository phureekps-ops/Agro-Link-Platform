/**
 * AgroLink Agricultural Community Enterprise Portal (วิสาหกิจชุมชนด้านการเกษตร) — shared API
 * client.
 *
 ...
 * browser.
 *
 * The one thing THIS portal's login() does differently: 'AgriCommunityEnterprise'
...
const AUTH_STORAGE_KEY = "agrolink_communityenterprise_session";
...
const AgroLinkCommunityEnterpriseAPI = (() => {
  function getSession() {
