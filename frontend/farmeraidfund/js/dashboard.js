...
async function loadOverview() {
  ...
  try {
    const data = await AgroLinkFarmerAidFundAPI.get("/organization/roles");
...
document.getElementById("logoutBtn").addEventListener("click", () => {
  AgroLinkFarmerAidFundAPI.logout();
});

(function init() {
  if (!AgroLinkFarmerAidFundAPI.requireSessionOrRedirect()) return;
  loadOverview();
})();
