...
function showRolePendingNotice(orgName, roleStatus) {
  ...
  const body = !roleStatus
    ? {
        ...
        detail: "หากต้องการเปิดใช้งานพอร์ทัลนี้ ท่านสามารถส่งคำขอเพิ่มบทบาทได้จากหน้า \"จัดการบทบาทธุรกิจ\" (เลือกได้จากบริการรถไถ โดรน/ฉีดพ่นสารเคมี รถเกี่ยวข้าว หรือรถบรรทุก — บริการลานตากข้าวแยกไปที่พอร์ทัลผู้ให้บริการลานตาก/โกดังและไซโลแล้ว)",
      }
    : roleStatus === "Rejected"
