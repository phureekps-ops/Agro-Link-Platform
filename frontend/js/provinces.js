/**
 * Thai provinces with their ISO 3166-2:TH codes — matches the format already
 * used in identity.farmer.region_code for the seeded farmers (e.g. "TH-18",
 * "TH-30"). region_code is plain text with no lookup table in the database,
 * so this list only exists here to give the registration form a real
